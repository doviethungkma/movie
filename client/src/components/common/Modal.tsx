...
const Modal = (props: IModalProps) => {
  ...
  return (
    <div className="w-screen h-screen fixed z-40">
      ...
      <div className="w-[90%] max-w-[872px] h-auto max-h-[90%]  absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-scroll no-scrollbar bg-background-color z-50">
        <div
